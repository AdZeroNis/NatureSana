...
'custom' => [
    'password' => [
        'regex' => 'رمز عبور باید حداقل ۶ کاراکتر و شامل حروف و اعداد باشد.',
    ],
    'phone' => [
        'regex' => 'شماره موبایل باید با 09 شروع شده و 11 رقم باشد.',
    ],
    'email' => [
        'email' => 'فرمت ایمیل وارد شده معتبر نیست. لطفاً ایمیل صحیح وارد کنید (مثلاً example@gmail.com).',
    ],
     'phone_number' => [
        'regex' => 'شماره موبایل باید با 09 شروع شده و 11 رقم باشد.',
    ],
    'productTypes' => [
        'required' => 'لطفاً انواع محصولات خود را شرح دهید.',
        'min' => 'توضیحات باید حداقل ۵ کاراکتر باشد.',
    ],
