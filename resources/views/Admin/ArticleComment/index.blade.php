        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    @if(app(App\Http\Controllers\Home\ArticleCommentController::class)->hasAdminReply($comment))
                ...
                <a href="{{ route('panel.article.comment.show', $comment->id) }}" class="btn btn-sm" style="color: #007bff;" title="جزئیات">
                    ...
                    <form id="delete-form-{{ $comment->id }}" action="{{ route('panel.article.comment.delete', $comment->id) }}" method="POST" style="display: none;">
                        @csrf
                        @method('DELETE')
                    </form>
                </td>
